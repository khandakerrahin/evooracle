...
# Customize the plot
bar_plot.set_title('Average Mutation Coverage by Class and Model for Evosuite enhanced with EvoOracle Assertions')
bar_plot.set_xlabel('Class')
bar_plot.set_ylabel('Average Mutation Coverage Score')
