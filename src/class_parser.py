...
class ClassParser():
    ...
    def get_function_metadata(class_identifier, function_node, class_fields, blob: str):
        ...
        method_invocations = []
        ClassParser.traverse_type(function_node, method_invocations, 'method_invocation')
        ...
        for invocation in method_invocations:
            ...
            method_invocation_name = ClassParser.match_from_span(name_node, blob)
    ...
    def get_method_invocation_name(invocation_node, blob: str) -> str:
        ...
        if method_name_node is not None:
            method_name = ClassParser.match_from_span(method_name_node, blob).strip()
        else:
            method_name = ""
        ...
        if object_node:
            ...
            if class_name_node is not None:
                class_name = ClassParser.match_from_span(class_name_node, blob).strip()
