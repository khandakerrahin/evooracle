...
class ParseTask:
    ...
    def find_classes(self, target_path):
        """
        Find all classes, including tests and non-test classes
        """
        # Run analysis
        ...
        return self.parse_all_classes(java, project_name, output), output

    def parse_all_classes(self, java_files, project_name, output):
        classes = {}
        for java_file in java_files:
            ...
            self.export_result(classes[java_file], json_path)
        return classes
