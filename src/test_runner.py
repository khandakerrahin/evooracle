...
class TestRunner:
    ...
    def run_single_test(self, test_file, test_path, target_path, package, class_name):
        ...
        commands = [
            ...
            "javac -cp target/classes:evosuite-standalone-runtime-1.2.0.jar:evosuite-tests:target/dependency/junit-4.12.jar:target/dependency/hamcrest-core-1.3.jar {}".format(test_file),
            "java -cp target/classes:evosuite-standalone-runtime-1.2.0.jar:evosuite-tests:target/dependency/junit-4.12.jar:target/dependency/hamcrest-core-1.3.jar org.junit.runner.JUnitCore {}.{}".format(package, class_name)
            # "$EVOSUITE",
